...
export default function Cart({
  ...
  if (!open) return null;
  const total = subtotal; // promo logic can be added later
  ...
  return (
    ...
    >
      ...
      >
        ...
        {promo && (
          <div style={{ background: "#F1F8F3", padding: 8, borderRadius: 8, marginBottom: 8 }}>
        ...
        <button onClick={onClose} style={{ marginTop: 8, width: "100%" }}>
          Continue Shopping
        </button>
      </div>
    </aside>
