...
export default function Contact(){
  ...
  async function submit(e: any){
    ...
    const r = await fetch("/api/lead", { method: "POST", headers: {"Content-Type":"application/json"}, body: JSON.stringify({ source: "contact", ...data }) });
    if(r.ok) setStatus("Thanks! We’ll reply shortly.");
    else setStatus("There was a problem—please try again.");
  }
  return (
